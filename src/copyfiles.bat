...
REM if not exist "%DBGHELPERS%\dbghelpdr.dll" copy "thirdparty\drmingw_build_%PLATFORM_BITS%\bin\mgwhelp.dll" "%DEST%\dbghelpdr.dll"
REM if errorlevel 1 ((@echo Failed to copy mgwhelp.dll : dbghelpdr.dll) & (exit /b 1))
